...
<div class="right_col" role="main">
    ...
    <div class="col-md">
        <div class="x_panel">
            <div class="x_title">
                <a href="<?= base_url('admin/transaksi') ?>" class="btn btn-primary mb-3" data-toggle="modal">
                    ❮ Kembali</a>
                <div class="clearfix">
                </div>
            </div>
            <div class="x_content">
                <form action="<?= base_url('admin/save_detail'); ?>" method="post" class="form-horizontal form-label-left input_mask">
                    ...
                    <div class="col-sm-5">
                        <div class=" form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="telepon" name="telepon" required="required" class="form-control" required="">
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3"><span class="Kg">
                                            <input type="text" name="Kg" size="2" class="form-control" required="">
                                        </span></td>
                                </tr>
                                <tr>
