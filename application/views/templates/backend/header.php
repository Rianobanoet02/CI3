...
<head>
    ...
    <link href="<?= base_url('assets/') ?>img/super.png" rel="icon">    

    <title>Super Laundry | <?= $user['nama']; ?> </title>
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"><!--<i class="fa fa-shopping-basket"></i>-->&nbsp;&nbsp;<img src="<?= base_url('assets/img/profile/sl.png');?>"><span> Super laundry!</span></a>
                    </div>
